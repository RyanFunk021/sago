"""
Sago shared chord definitions — canonical source of truth.
Mirrors language/CHORDS.md. Import this in all Sago tools.
"""
...
# Reverse lookups
BY_NAME = {v["name"]: syl for syl, v in CHORDS.items()}
BY_LEVEL = {lvl: [syl for syl, v in CHORDS.items() if v["level"] == lvl] for lvl in range(1, 6)}


def chord_inventory_string() -> str:
